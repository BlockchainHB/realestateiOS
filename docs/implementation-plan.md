...
- SQL migrations establish public RLS-protected records and a non-exposed `private` schema for encrypted OAuth tokens, one-time authorization state, cancellable connection intents, and Pub/Sub receipts.
